...
( isset($linkTextField) ) ? $linkTextField : $linkTextField = 'description,menutitle,pagetitle,longtitle';
( isset($linkDescField) ) ? $linkDescField : $linkDescField = 'longtitle,description,pagetitle,menutitle';
...
$templates = array(
    'defaultString' => array(
        'crumb' => '[+crumb+]',
        'separator' => ' '.$separator.' ',
        'crumbContainer' => '<ol itemscope itemtype="https://schema.org/BreadcrumbList" class="[+crumbBoxClass+]">[+crumbs+]</ol>',
...
foreach ( $crumbs as $c )
{
    ...
    )
    {
        ...
        $pretemplateCrumb .= 
			'<li itemprop="itemListElement" itemscope itemtype="https://schema.org/ListItem">
				<a itemprop="item" class="'.$crumbClass.'" href="'.($c['id'] == $modx->config['site_start'] ? $modx->config['base_url'] : $modx->makeUrl($c['id'])).'" title="'.$title.'">
    ...
    // Make a span instead of a link
    {
       $pretemplateCrumb .= 
		    '<li itemprop="itemListElement" itemscope itemtype="https://schema.org/ListItem">
		    	<span itemprop="name" class="'.$crumbClass.'">'.$text.'</span>
				<meta itemprop="position" content='.count($crumbs).' />
			</li>';
    }
